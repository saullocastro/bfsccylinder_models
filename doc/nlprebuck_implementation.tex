...
$\boldsymbol{K}_{C0} + \boldsymbol{K}_C^{NL}(\boldsymbol{u}) +
...
\simeq 0.9968$, the default \texttt{NLprebuck\_eps1}.  On the $n_y = 60$,
...
\begin{enumerate}\itemsep3pt
  \item \textbf{Degenerate critical modes.}  The rotation inside the
        degenerate pair still moves $b_{1111}$ by sixteen per cent on the
        $n_y = 40$ mesh, almost all of it through the nodal normalisation
