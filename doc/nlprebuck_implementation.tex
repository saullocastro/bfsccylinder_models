...
Sun, rotated $30^\circ$ & 40 & 11 & 1.0021 & 1.1328 & $-0.19275$ & $-0.15022$ \\
\midrule
Arbocz & 60 & 25 & 1.0000 & 1.0021 & $-0.35646$ & $-0.35498$ \\
       ...
       & 60 & 51 & 1.0000 & 1.0000 & $-0.35742$ & $-0.35739$ \\
...
\texttt{doc/verification/reference\_b\_convergence.py}.
...
shell, $n_y = 60$, including it changes $b_{1111}$ by $4\times10^{-7}$
...
\emph{Kinematics.}  The Sanders model on the $n_y = 60$, $n_x = 51$ mesh gives
$b_{1111} = -0.34915$ and $\lambda_c = 0.328545$, $2.3$ per cent further from
...
vacuous.  \texttt{cts\_mesh\_convergence.py} is the run that exhausted the
former default \texttt{NLprebuck\_maxiter=12}, which is why the default is now
$30$, see Section~\ref{sec:cts-nl}.
