...
and $n = 10$, rotating the critical pair by $30$ degrees moves $b_{1111}$ from
...
Sun, $n_y = 50$    & $10$ & $-0.222760$ & --- \\
\bottomrule
\end{tabular}
\end{center}

The $n_y = 60$ value is $5.2$ per cent short of the ANILISA coefficient for
the same mode, a difference Section~\ref{sec:gap} takes apart.  A negative
