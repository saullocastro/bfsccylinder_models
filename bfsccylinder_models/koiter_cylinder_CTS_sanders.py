...
def nonlinear_rows(elem, xi, eta):
    ...
    gamma_xy^NL = (G1 u) (G2 u), see koiter_element_tensors. Sanders
    kinematics
    """
    ...
    #     Karman kinematics in every Koiter tensor.
    G1 = Sw_x
    G2 = Sw_y - Sv/elem.R
    return G1, G2
...
def calc_AB(elem):
    ...
    Two (nint, nint, 3, 3) arrays, see koiter_element_tensors. They vary
    along x with the steering angle of the tows
    """
    A = np.array([
